...
public class ModItems {
    ...
    public static final DeferredItem<ArmorItem> PIXIE_CHASSIS = ITEMS.register("pixie_chassis",
            () -> new PixieChassisItem(
                    ModArmorMaterials.SUIT_ARMOR_MATERIAL,
                    ArmorItem.Type.CHESTPLATE,
                    new Item.Properties()
                            .durability(ArmorItem.Type.CHESTPLATE.getDurability(42))
                            .component(ModDataComponents.AIR_SUPPLY.get(), PixieChassisItem.MAX_AIR_CAPACITY)
                            .component(ModDataComponents.FLUID_TANK.get(), SimpleFluidContent.EMPTY)
            )
    );
    ...
    public static final DeferredItem<Item> NECTAR_BUCKET = ITEMS.register("nectar_bucket",
            () -> new BucketItem(
